    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <a href="{{ route('admin.exam-schedules.create') }}" class="btn btn-primary me-2">
                        <i class="bi bi-plus-circle"></i> เพิ่มตารางสอบ
                    </a>
                    <a href="{{ route('admin.exam-schedules.calendar') }}" class="btn btn-success me-2">
                        <i class="bi bi-calendar3"></i> มุมมองปฏิทิน
                    </a>
                    <a href="{{ route('admin.system.index') }}" class="btn btn-secondary">
                                ...
                                @forelse($examSchedules as $schedule)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.exam-schedules.edit', $schedule->ex_id) }}" class="btn btn-sm btn-warning me-1">
...
function deleteSchedule(scheduleId) {
    ...
    fetch(`/admin/exam-schedules/${scheduleId}`, {
        method: 'DELETE',
        headers: {
