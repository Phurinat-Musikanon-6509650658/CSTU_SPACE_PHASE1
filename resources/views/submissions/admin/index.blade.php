...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            <div>
                <a href="{{ route('menu') }}" class="btn btn-link text-decoration-none ps-0 text-muted mb-1">
                    <i class="bi bi-chevron-left me-1"></i>กลับเมนูหลัก
                </a>
                <h2 class="mb-0">
                            ...
                            <table class="table table-modern table-hover align-middle">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th width="15%" class="text-center">การดำเนิน</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($projects as $project)
                                        <tr>
                                            ...
                                            <td>
                                                @if($project->advisor)
                                                    <small>{{ $project->advisor->first_name }} {{ $project->advisor->last_name }}</small>
                                                @else
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.submissions.show', $project->project_id) }}"
                                                   class="btn btn-sm btn-outline-primary btn-action" title="ดูรายละเอียด">
                                                    <i class="bi bi-eye"></i> ดู
                                                </a>
                                                <a href="{{ route('admin.submissions.download', $project->project_id) }}"
