...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            <div>
                <a href="{{ route('lecturer.dashboard') }}" class="btn btn-link text-decoration-none ps-0 text-muted mb-1">
                    <i class="bi bi-chevron-left me-1"></i>กลับ Dashboard
                </a>
                <h2 class="mb-0">
                    <i class="bi bi-file-pdf-fill" style="color: #667eea;"></i> เล่มโครงงานที่ส่ง
                </h2>
