            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="username_std" class="form-label">รหัสนักศึกษา <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="password_std" class="form-label">Password <span class="text-danger">*</span></label>
